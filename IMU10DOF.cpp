...
IMU10DOF::IMU10DOF(PinName sda, PinName scl) : acc(sda,scl), magn(sda,scl),gyro(sda,scl), baro(sda,scl),pc(USBTX,USBRX)
{
...
void IMU10DOF::init(bool fastmode)
{
...
void IMU10DOF::getRawValues(int16_t * raw_values)
{
    int16_t raw3[3];
    int raw[3];
...
*/
void IMU10DOF::getValues(float * values)
{
...
*/
//#if IS_9DOM()
void  IMU10DOF::AHRSupdate(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz)
{
...
*/
float IMU10DOF::getBaroAlt(float sea_press)
{
...
*/
void IMU10DOF::gravityCompensateAcc(float * acc, float * q)
{
    float g[3];
...
*/
void IMU10DOF::getEulerRad(float * angles)
{
...
*/
void IMU10DOF::getEuler(float * angles)
{
    getEulerRad(angles);
 ...
 * angles from Earth and the IMU. For Euler representation Yaw, Pitch and Roll see IMU10DOF::getEuler
 *
 * @param ypr three floats array which will be populated by Yaw, Pitch and Roll angles in radians
*/
void IMU10DOF::getYawPitchRollRad(float * ypr)
{
    float q[4]; // quaternion
...
*/
void IMU10DOF::getYawPitchRoll(float * ypr)
{
