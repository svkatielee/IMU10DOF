...
along with this program.  If not, see <http://www.gnu.org/licenses/>.
 ...
 Now ported to support DFRobot.com 10DOF MEMS IMU
 by Larry Littlefield svkatielee@yahoo.com
...
10DOF_IMU::10DOF_IMU(PinName sda, PinName scl) : acc(sda,scl), magn(sda,scl),gyro(sda,scl), baro(sda,scl),pc(USBTX,USBRX)
{
...
void 10DOF_IMU::init(bool fastmode)
{
...
void 10DOF_IMU::getRawValues(int16_t * raw_values)
{
    int16_t raw3[3];
    int raw[3];
...
*/
void 10DOF_IMU::getValues(float * values)
{
...
*/
//#if IS_9DOM()
void  10DOF_IMU::AHRSupdate(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz)
{
...
*/
float 10DOF_IMU::getBaroAlt(float sea_press)
{
...
*/
void 10DOF_IMU::gravityCompensateAcc(float * acc, float * q)
{
    float g[3];
...
*/
void 10DOF_IMU::getEulerRad(float * angles)
{
...
*/
void 10DOF_IMU::getEuler(float * angles)
{
    getEulerRad(angles);
 ...
 * angles from Earth and the IMU. For Euler representation Yaw, Pitch and Roll see 10DOF_IMU::getEuler
 *
 * @param ypr three floats array which will be populated by Yaw, Pitch and Roll angles in radians
*/
void 10DOF_IMU::getYawPitchRollRad(float * ypr)
{
    float q[4]; // quaternion
...
*/
void 10DOF_IMU::getYawPitchRoll(float * ypr)
{
